...
# Custom Bastion Pool Selection (Matches 5)
execute if score bastion settings matches 5 if score spawnpoint_custom settings matches 0 run function practice:_start/_teleport_to_spawnpoint/random
execute if score bastion settings matches 5 if score spawnpoint_custom settings matches 1 run function practice:_start/_teleport_to_spawnpoint/predefined
execute if score bastion settings matches 5 if score spawnpoint_custom settings matches 2 run function practice:_start/_teleport_to_spawnpoint/terrain
