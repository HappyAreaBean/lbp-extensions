...
execute if score bastion settings matches ..-1 run scoreboard players set bastion settings 4
...
execute if score spawnpoint_bridge settings matches ..-1 run scoreboard players set spawnpoint_bridge settings 10
execute if score spawnpoint_stables settings matches 12.. run scoreboard players set spawnpoint_stables settings 0
execute if score spawnpoint_stables settings matches ..-1 run scoreboard players set spawnpoint_stables settings 11
execute if score spawnpoint_treasure settings matches 8.. run scoreboard players set spawnpoint_treasure settings 0
execute if score spawnpoint_treasure settings matches ..-1 run scoreboard players set spawnpoint_treasure settings 7
execute if score spawnpoint_units settings matches 10.. run scoreboard players set spawnpoint_units settings 0
execute if score spawnpoint_units settings matches ..-1 run scoreboard players set spawnpoint_units settings 9
