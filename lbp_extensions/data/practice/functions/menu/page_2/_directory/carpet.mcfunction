...
execute if score selection chest_menu matches 8 if score items chest_menu matches 2 run scoreboard players add guarantee_loot bastion.settings 1
execute if score selection chest_menu matches 8 if score items chest_menu matches 1 run scoreboard players remove guarantee_loot bastion.settings 1
