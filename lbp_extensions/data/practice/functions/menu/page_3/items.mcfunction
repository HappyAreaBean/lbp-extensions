...
replaceitem entity @s enderchest.22 nether_star{menu:1,page:3,selection:6,display:{Name:'[{"text":"Back","italic":false,"color":"red"}]',Lore:['[{"text":""}]','[{"text":"Click to return to","italic":false,"color":"white"}]','[{"text":"the previous page","italic":false,"color":"white"}]']},HideFlags:2}
