execute if score selection chest_menu matches 1 if score items chest_menu matches 2 run scoreboard players add bridge_left_rampart bastion.settings 1
execute if score selection chest_menu matches 1 if score items chest_menu matches 1 run scoreboard players remove bridge_left_rampart bastion.settings 1
execute if score selection chest_menu matches 2 if score items chest_menu matches 2 run scoreboard players add bridge_right_rampart bastion.settings 1
execute if score selection chest_menu matches 2 if score items chest_menu matches 1 run scoreboard players remove bridge_right_rampart bastion.settings 1
